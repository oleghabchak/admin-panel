        ...
        const createActive = () => {
            ...
            elements.forEach((element) => {
                ...
                if (cursor !== 'pointer' && childNodeCount) {
                    ...
                    const inactiveStyle = (0, util_1.deepMix)(originalAttrs, state.inactive);
                    element.addEventListener('mouseenter', () => {
                        if (duration) {
                            element.attr('zIndex', (0, util_1.get)(state, ['active', 'zIndex'], 2));
                            element.animate([
                                (0, util_1.omit)(inactiveStyle, ['zIndex']),
                                (0, util_1.omit)(state.active, ['zIndex']),
                            ], {
                                duration,
                                fill: 'forwards'
                            });
                    ...
                    element.addEventListener('mouseleave', () => {
                        if (duration) {
                            ...
                            setTimeout(() => {
                                element.attr('zIndex', (0, util_1.get)(inactiveStyle, ['zIndex'], 1));
                            }, duration);
                        }
                        else {
